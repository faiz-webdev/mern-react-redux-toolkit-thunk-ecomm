                    ...
                    <div className="space-y-12">
                      ...
                      <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button
                          ...
                          className="rounded-md bg-indigo-grey-500 px-3 py-2 text-sm font-semibold text-grey shadow-sm hover:bg-indigo-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                          Cancel
                        </button>
                        &nbsp;
